    ...
    (set, get) => ({
      ...
      incidentOptionLists: {
        accidentTypes: [
          ...
          { id: "contusion", label: "Contusion (ecchymose)" },
          { id: "brulure-chimique", label: "Brûlure chimique" },
          { id: "brulure-thermique", label: "Brûlure thermique" },
          ...
          { id: "luxation", label: "Luxation" },
          { id: "maladie-poussiere", label: "Maladie due à la poussière" },
          { id: "choc-electrique", label: "Choc électrique" },
          { id: "perte-oeil", label: "Perte de l'œil (énucléation)" },
          { id: "corps-etranger", label: "Corps étranger" },
          { id: "fracture", label: "Fracture" },
          { id: "gelure", label: "Gelure" },
          ...
          { id: "epuisement-chaleur", label: "Épuisement dû à la chaleur (prostration)" },
          ...
          { id: "intoxication-chimique", label: "Intoxication chimique" },
          { id: "intoxication-generale", label: "Intoxication générale" },
          { id: "intoxication-metaux", label: "Intoxication aux métaux" },
          { id: "perforation", label: "Perforation" },
          { id: "radiation", label: "Radiation" },
          { id: "eruption-cutanee", label: "Éruption cutanée / plaies / cloques (dermatite)" },
          { id: "problemes-respiratoires", label: "Problèmes respiratoires" },
        ...
        danger: [
          ...
          { id: "danger-luxation", label: "Luxation" },
        ...
        injuryTypes: [
          ...
          { id: "inj-luxation", label: "Luxation" },
          ...
          { id: "inj-radiotherapie", label: "Radiothérapie" },
          ...
          { id: "inj-encrassement", label: "Encrassement" },
