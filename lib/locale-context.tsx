...
const translations = {
  en: {
    ...
    "livrable.requiredResponseDate": "Required Response Date",
    "livrable.managerOption.projectManager": "Project manager",
    ...
    "alert.groupCreated": "Group created successfully",
    "alert.groupDeleted": "Group deleted",
    ...
    "role.admin": "Admin",
    "role.admin.description": "Administrators with full system access",
    "role.supervisor": "Supervisor",
    "role.supervisor.description": "Supervisors who can manage workers and review forms",
    "role.worker": "Worker",
    "role.worker.description": "Workers who can create and submit forms",
    "azure.connectSuccess": "Connected to Azure AD successfully",
    "azure.connectFailed": "Failed to connect to Azure AD",
    "azure.loadGroupsFailed": "Failed to load Azure AD groups",
    "azure.groupConfigured": "Configured {role} group: {groupName}",
    "azure.configureGroupFailed": "Failed to configure {role} group",
    "azure.noGroupConfigured": "No Azure AD group configured for {role}",
    "azure.usersSynced": "Synced {count} users from {role} group",
    "azure.syncGroupFailed": "Failed to sync {role} group",
    "azure.connectButton": "Connect to Azure AD",
    "azure.notConfigured": "Azure AD Not Configured",
    "azure.refreshGroups": "Refresh Groups",
    "azure.notConfiguredAlert": "Azure AD is not configured. Please set the following environment variables:",
    "azure.configured": "Configured",
    "azure.adGroup": "Azure AD Group:",
    "azure.members": "Members:",
    "azure.lastSynced": "Last Synced:",
    "azure.syncing": "Syncing...",
    "azure.syncUsers": "Sync Users",
    "azure.configureGroup": "Configure {role} Group",
    "azure.selectGroupForRole": "Select an Azure AD group for {role} role",
    "azure.searchGroups": "Search Groups",
    "azure.searchGroupsPlaceholder": "Search Azure AD groups...",
    "azure.noGroupsFound": "No groups found",
    "azure.searchForGroups": "Search for Azure AD groups",
    "azure.noGroupForRole": "No Azure AD group configured for this role",
    "azure.configureGroupButton": "Configure Group",
    "azure.usersByRole": "Users by Role",
    "azure.usersByRoleDescription": "Users synced from Azure AD Groups and their assigned roles",
    "azure.table.name": "Name",
    "azure.table.email": "Email",
    "azure.table.role": "Role",
    "azure.table.group": "Azure AD Group",
    "azure.table.status": "Status",
    "azure.noUsersSynced": "No users synced yet. Configure and sync Azure AD groups above.",
    "azure.notAssigned": "Not assigned",
    "azure.synced": "Synced",
    "azure.local": "Local",
    ...
    "createFirstGroupDescription": "Create your first group to organize team members",
  ...
  fr: {
    ...
    "livrable.requiredResponseDate": "Date de réponse requise",
    "livrable.managerOption.projectManager": "Chargé de projet du projet",
    ...
    "alert.groupDeleted": "Groupe supprimé",
    ...
    // Roles and Users (Azure AD) - French
    "rolesAndUsers": "Rôles et utilisateurs",
    "rolesAndUsersDescription": "Gérer le contrôle d'accès basé sur les rôles avec les groupes Microsoft Azure AD",
    "role.admin": "Administrateur",
    "role.admin.description": "Administrateurs avec accès complet au système",
    "role.supervisor": "Superviseur",
    "role.supervisor.description": "Superviseurs qui peuvent gérer les ouvriers et examiner les formulaires",
    "role.worker": "Ouvrier",
    "role.worker.description": "Ouvriers qui peuvent créer et soumettre des formulaires",
    "azure.connectSuccess": "Connecté à Azure AD avec succès",
    "azure.connectFailed": "Échec de la connexion à Azure AD",
    "azure.loadGroupsFailed": "Échec du chargement des groupes Azure AD",
    "azure.groupConfigured": "Groupe {role} configuré : {groupName}",
    "azure.configureGroupFailed": "Échec de la configuration du groupe {role}",
    "azure.noGroupConfigured": "Aucun groupe Azure AD configuré pour {role}",
    "azure.usersSynced": "{count} utilisateurs synchronisés depuis le groupe {role}",
    "azure.syncGroupFailed": "Échec de la synchronisation du groupe {role}",
    "azure.connectButton": "Se connecter à Azure AD",
    "azure.notConfigured": "Azure AD non configuré",
    "azure.refreshGroups": "Actualiser les groupes",
    "azure.notConfiguredAlert": "Azure AD n'est pas configuré. Veuillez définir les variables d'environnement suivantes :",
    "azure.configured": "Configuré",
    "azure.adGroup": "Groupe Azure AD :",
    "azure.members": "Membres :",
    "azure.lastSynced": "Dernière synchronisation :",
    "azure.syncing": "Synchronisation...",
    "azure.syncUsers": "Synchroniser les utilisateurs",
    "azure.configureGroup": "Configurer le groupe {role}",
    "azure.selectGroupForRole": "Sélectionner un groupe Azure AD pour le rôle {role}",
    "azure.searchGroups": "Rechercher des groupes",
    "azure.searchGroupsPlaceholder": "Rechercher des groupes Azure AD...",
    "azure.noGroupsFound": "Aucun groupe trouvé",
    "azure.searchForGroups": "Rechercher des groupes Azure AD",
    "azure.noGroupForRole": "Aucun groupe Azure AD configuré pour ce rôle",
    "azure.configureGroupButton": "Configurer le groupe",
    "azure.usersByRole": "Utilisateurs par rôle",
    "azure.usersByRoleDescription": "Utilisateurs synchronisés depuis les groupes Azure AD et leurs rôles assignés",
    "azure.table.name": "Nom",
    "azure.table.email": "Email",
    "azure.table.role": "Rôle",
    "azure.table.group": "Groupe Azure AD",
    "azure.table.status": "Statut",
    "azure.noUsersSynced": "Aucun utilisateur synchronisé pour le moment. Configurez et synchronisez les groupes Azure AD ci-dessus.",
    "azure.notAssigned": "Non assigné",
    "azure.synced": "Synchronisé",
    "azure.local": "Local",
    ...
    "createFirstGroupDescription": "Créez votre premier groupe pour organiser les membres de l'équipe",
