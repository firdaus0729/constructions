...
export function ObservationDangerCrudCombobox({
  value,
  onChange,
  placeholder,
}: {
  ...
  const { t } = useLocale()
  const { observationOptionLists, addObservationDangerOption, updateObservationDangerOption, deleteObservationDangerOption } = useAppStore()
  ...
  const items = observationOptionLists.danger || []
  ...
  const saveEdit = () => {
    ...
    if (!next) return
    updateObservationDangerOption(editingId, { label: next })
    cancelEdit()
  }
  ...
  const addNew = () => {
    ...
    addObservationDangerOption({ id, label: trimmed })
    onChange(id)
    setNewLabel("")
    setOpen(false)
  }
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              ...
                              if (confirm(t("settings.livrableOptions.confirmDelete"))) {
                                deleteObservationDangerOption(it.id)
